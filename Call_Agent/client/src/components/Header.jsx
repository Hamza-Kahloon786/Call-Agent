        ...
        <div className="mt-4 flex items-center justify-between h-16 rounded-2xl bg-white/70 backdrop-blur-lg shadow-md border border-white/80 px-6">
          ...
          <nav className="hidden md:flex items-center space-x-2">
            ...
            <Button 
              ...
              className="bg-orange-500 text-white hover:bg-orange-600 rounded-lg"
            >
              Contact
            </Button>
            ...
            {!checkingAuth && (
              user ? (
                <Link to="/dashboard">
                  <Button className="bg-blue-500 text-white hover:bg-blue-600 rounded-lg flex items-center gap-2">
                    <User size={18} />
                    Dashboard
                  </Button>
                </Link>
                ...
                <Link to="/login">
                  <Button className="bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 rounded-lg flex items-center gap-2 shadow-md">
                    <LogIn size={18} />
                    Login
                  </Button>
                </Link>
